...
def number_of_vehicle():
    ...
    if len(all_vehicles) > 1:
        ...
        for  distance_of_car, vehichle in sorted_vehicles:
...
def car_control():
    ...
    time.sleep(4)
    dropped_vehicle.apply_control(carla.VehicleControl(throttle=0.5,steer=1))
    ...
    dropped_vehicle.set_light_state(carla.VehicleLightState(carla.VehicleLightState.LowBeam))  #Turn on LowBeam light
    time.sleep(1)
    dropped_vehicle.apply_control(carla.VehicleControl(throttle=0.4)) 
    dropped_vehicle.set_light_state(carla.VehicleLightState(carla.VehicleLightState.LowBeam)) #Turn on LowBeam light
    time.sleep(3)
    dropped_vehicle.apply_control(carla.VehicleControl(hand_brake=True))
    dropped_vehicle.set_light_state(carla.VehicleLightState(carla.VehicleLightState.Brake | carla.VehicleLightState.LowBeam)) #Turn on Brake light
    time.sleep(5)
try:
    ...
    spawn_point = (world.get_map().get_spawn_points('police')[1])
